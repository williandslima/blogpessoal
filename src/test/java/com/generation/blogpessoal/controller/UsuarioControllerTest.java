...
//	}
	...
	@Test
	@DisplayName("Buscar Usuário por ID") // Com ID dinamico
	public void buscarUsuarioPorId() {
		// cadastrar usuario em memoria e salvar na var optional (tem acesso aos metodos
		// do option, get, set etcs)
		Optional<Usuario> novoUsuario = usuarioService.cadastrarUsuario(
				new Usuario(0L, "Antonio", "antonio@email.com.br", "sabrina123", "https://i.imgur.com/5M2p5Wb.jpg"));
	...
	public void buscarUsuarioPorId2() {
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "Antonio", "antonio@email.com.br", "sabrina123", "https://i.imgur.com/5M2p5Wb.jpg"));

		ResponseEntity<Usuario> resposta = testRestTemplate.withBasicAuth("root@root.com", "rootroot")
				.exchange("/usuarios/{id}", HttpMethod.GET, null, Usuario.class, 1);
