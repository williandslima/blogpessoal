...
public class UsuarioControllerTest {
	 ...
	 * @Test
	 * 
	 * @DisplayName("Atualizar um Usuário") public void deveAtualizarUmUsuario() {
	 * 
	 * Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new
	 * Usuario(0L, "Juliana Andrews", "juliana_andrews@email.com.br", "juliana123",
	 ...
	 * .withBasicAuth("root@root.com", "rootroot") .exchange("/usuarios/atualizar",
	 * HttpMethod.PUT, corpoRequisicao, Usuario.class);
	 * 
	 * assertEquals(HttpStatus.OK, corpoResposta.getStatusCode());
	 * assertEquals(corpoRequisicao.getBody().getNome(),
	 * corpoResposta.getBody().getNome());
	 * assertEquals(corpoRequisicao.getBody().getUsuario(),
	 * corpoResposta.getBody().getUsuario()); }
	 */
	@Test
	...
	public void logarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Willian Lima",
				"paulo_antunes@email.com.br", "13465278", "https://i.imgur.com/JR7kUFU.jpg"));
	...
	public void buscarUsuarioPorId() {
		usuarioService.cadastrarUsuario(new Usuario(0L, "Antonio", "antonio@email.com.br", "sabrina123",
				"https://i.imgur.com/5M2p5Wb.jpg"));
		usuarioService.cadastrarUsuario(new Usuario(0L, "Davi Marques", "davi@email.com.br", "ricardo123",
				"https://i.imgur.com/Sk5SjWE.jpg"));

		ResponseEntity<Usuario> resposta = testRestTemplate.withBasicAuth("root@root.com", "rootroot")
				.exchange("/usuarios/{id}", HttpMethod.GET, null, Usuario.class, 6);
